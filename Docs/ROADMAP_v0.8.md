...
- Noms affichés : Aquis / Aquiloryons / Aquilances / Aquisphères / Aquilombres.
...
- HUD `DrawCityView` : fond `Cite_Aquiloris.png`, compteur de cristaux, cartes de bâtiments
  cliquables (Académie→Aquiloryons, Dôme→Aquilances, Champ de tir→Aquisphères, Nexus→Aquilombres,
...
- Cité : bâtiment Aquisphères/Noxeblast à construire sur l'une des 3 parcelles libres, coûts
...
Aquis / Aquiloryons / Aquilances / Aquisphères / Aquilombres, factions démo = Aquiloris + Noxéens.
